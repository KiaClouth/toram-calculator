...
export default function Loading() {
  return (
    ...
    <div className="LoadingPage bg-aeskl lg:fixed flex justify-center items-center left-0 top-0 z-20 h-dvh w-dvw bg-cover bg-center">
      <div className="LoadingMask fixed to-primary-color-0 h-full w-full left-0 top-0 bg-gradient-to-b lg:bg-gradient-to-t from-primary-color from-10% to-25% lg:from-5% lg:to-20%"></div>
