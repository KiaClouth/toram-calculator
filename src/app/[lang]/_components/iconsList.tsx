export const IconBasketball = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="2" y="2.5" width="20" height="20" rx="10" stroke="currentColor" strokeWidth="1.5" />
      <path
      ...
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M12 2.5V22.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M22 12.5L2 12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
};
...
export const IconCalendar = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="3" y="3.5" width="18" height="18" rx="5" stroke="currentColor" strokeWidth="1.5" />
      <path d="M3 8.49997H21" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      <path
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M6.5 12.5H7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M11.5 12.5H12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16.5 12.5H17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6.5 16.5H7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M11.5 16.5H12.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16.5 16.5H17.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
...
export const IconCategory2 = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="4" y="4.5" width="7" height="4" rx="2" stroke="currentColor" strokeWidth="1.5" />
      <rect x="4" y="11.5" width="7" height="10" rx="2.5" stroke="currentColor" strokeWidth="1.5" />
      <rect x="14" y="4.5" width="7" height="10" rx="2.5" stroke="currentColor" strokeWidth="1.5" />
      <rect x="14" y="17.5" width="7" height="4" rx="2" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
};
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M12 15L12 21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
};
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M6 11.4756H10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
...
export const IconCalculactor = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="4" y="2" width="16" height="20" rx="4" stroke="currentColor" strokeWidth="1.5" />
      <rect x="8" y="6" width="8" height="3" rx="1" stroke="currentColor" strokeWidth="1.5" />
      <path d="M9 18H8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M9 14H8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M15 18H16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M15 14L16 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
};
...
export const IconLogo = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg" fill="none" {...props}>
      ...
      />
      <rect x="12.3611" y="12.2222" width="8.61111" height="27.7778" rx="4.30556" className=" fill-accent-color" />
      <rect
        x="23.2077"
        y="28.6913"
        width="5.20137"
      ...
      <rect
        ...
        className=" fill-brand-color-2nd"
      />
      <rect x="24.4444" y="11.8055" width="12.7778" height="12.7778" rx="6.38889" className=" fill-brand-color-3rd" />
    </svg>
  );
};
...
export const IconElementNoElement = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <g opacity="0.1">
...
export const IconLogoText = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="366" height="73" viewBox="0 0 366 73" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <rect x="28.3" y="18.1" width="12.4" height="40" rx="6.2" className=" fill-accent-color" />
      <rect
        x="43.919"
        y="41.8155"
        width="7.48997"
      ...
      <rect
        ...
        className=" fill-brand-color-2nd"
      />
      <rect x="45.7" y="17.5" width="18.4" height="18.4" rx="9.2" className=" fill-brand-color-3rd" />
      <path
...
export const IconFaceBrowser = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
export const IconFaceBasketball = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const IconFaceCategory2 = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export const IconFaceBox2 = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
export const IconFaceHeart = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
export const IconFaceLayers = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
...
export const IconFaceGamepad = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        opacity="0.3"
...
export const IconFaceUser = (props: React.SVGAttributes<SVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <circle
        opacity="0.3"
