  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div className={`DialogContent flex items-center flex-none max-h-[100dvh] min-h-[40dvh] flex-col bg-primary-color-90 overflow-y-auto shadow-2xl shadow-transition-color-20 ${state ? " lg:max-h-[80dvh]" : "lg:max-h-[75dvh]"}`}>
          {children}
        </div>
        <div className="DialogCloseBtn flex-1 cursor-pointer" onClick={handleClose}></div>
      </div>
